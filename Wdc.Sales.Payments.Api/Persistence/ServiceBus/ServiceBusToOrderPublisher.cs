...
{
    public class ServiceBusToOrderPublisher
    {
        ...
        public ServiceBusToOrderPublisher(IOptions<ServiceBusToProductOptions> options, IConfiguration configuration)
        {
            ServiceBusClient client = new(configuration.GetConnectionString("ServiceBusToOrder"));
